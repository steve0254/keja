    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="max-w-sm text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a
            href="/"
            className="press rounded-2xl border border-border bg-card px-5 py-3 text-sm font-medium"
          >
            Home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/23aa79f4-67d6-4566-8b41-eddc93dfa913/id-preview-df2dd7f6--d41e0eb8-edb5-4fc1-98e5-a675fe21e12b.lovable.app-1783581801063.png",
      },
      {
        name: "twitter:image",
        content:
